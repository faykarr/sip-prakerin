    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/"><img src="/assets/compiled/svg/upt-komp.svg" alt="Logo" srcset="" style="height:32px;" /></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?= ($uri->getSegment(1) === '' || $uri->getSegment(1) === 'dashboard') ? 'active' : '' ?>">
                ...
                <li class="sidebar-item has-sub <?= ($uri->getSegment(1) === 'master-data') ? 'active' : '' ?>">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item <?= ($uri->getSegment(2) === 'prakerin') ? 'active' : '' ?>">
                            <a href="/master-data/prakerin" class="submenu-link">Anak Prakerin</a>
                        </li>
                ...
                <li class="sidebar-item has-sub <?= ($uri->getSegment(1) === 'input-data') ? 'active' : '' ?>">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item <?= ($uri->getSegment(2) === 'nilai') ? 'active' : '' ?>">
                            <a href="/input-data/nilai" class="submenu-link">Input Nilai Prakerin</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub <?= ($uri->getSegment(1) === 'cetak-data') ? 'active' : '' ?>">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item <?= ($uri->getSegment(2) === 'nilai') ? 'active' : '' ?>">
                            <a href="/cetak-data/nilai" class="submenu-link">Cetak Nilai Prakerin</a>
                        </li>
