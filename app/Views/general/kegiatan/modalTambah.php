<!-- Modal -->
<div class="modal fade text-left" id="tambahBAKModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
    aria-hidden="true">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_asisten" class="form-control" placeholder="nama_asisten"
                                    name="nama_asisten" value="<?= $first_name . " " . $last_name ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="asisten_pembantu" id="asisten_pembantu"
                                    ...
                                    <?php foreach ($asisten as $s): ?>
                                        <option <?= (old('asisten_pembantu') == $s['id_asisten'] ? 'selected' : '') ?>
                                            value="<?= $s['id_asisten'] ?>"><?= $s['nama_asisten'] ?></option>
                                    <?php endforeach; ?>
                                </select>
